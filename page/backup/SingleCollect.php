...
class Page_SingleCollect extends Page {
    ...
    function init() {
        ...
        $f = $this->add('Form');
        $f->add('H3')->set('Collect single item from Transit/Funcitonal Store');
        $f->setModel($spare);
...
//        
        ...
        $dest_stores->addCondition('store_type',array('Regional Store','Warehouse'));
        $out = array();
